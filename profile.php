                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        <label for="user-id">Nom et prénom</label>
                                        <input type="text" name="name" class="form-control" placeholder="Enter Nom et prénom">
                                    </div>

                                    <div class="form-group">
                                        <label for="phone">Numéro de contact</label>
                                        <input type="number" name="phone" class="form-control" placeholder="Entrer Telephone" maxlength="10">
                                    </div>
