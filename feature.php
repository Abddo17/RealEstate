                    ...
                    <table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
                        <thead>
                            <tr class="bg-dark">
                                ...
                                <th class="text-white font-weight-bolder">Ajouter la date</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-capitalize">à <?php echo $row['5']; ?></td>
                                    <td><?php echo $row['28']; ?></td>
                                    <td class="text-capitalize"><?php echo $row['23']; ?></td>
                                    <td><a class="btn btn-info" href="submitpropertyupdate.php?id=<?php echo $row['0']; ?>">Mise à jour</a></td>
