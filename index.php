                                ...
                                <form method="post" action="propertygrid.php">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-lg-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="city" placeholder="Entrer la ville " required>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <p>Vente de biens immobiliers résidentiels, tels que des maisons, des appartements et des condos</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <p>Location de maisons et d'appartements pour des séjours à court terme ou à long terme..</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <p>Mise en liste de biens immobiliers à vendre ou à louer, avec des descriptions détaillées et des photos..</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <p>Consultation juridique pour la planification successorale, la rédaction de testaments et de procurations.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="featured-thumb hover-zoomer mb-4">
                                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18']; ?>" alt="pimage" style="height: 260px;">
                                                        <div class="featured bg-success text-white">Nouvelle</div>
                                                        <div class="sale bg-success text-white text-capitalize">à <?php echo $row['5']; ?></div>
                                                        <div class="price text-primary"><b>MAD <?php echo $row['13']; ?> </b><span class="text-white"><?php echo $row['12']; ?> Sqft</span></div>
                                                    </div>
                                                    <div class="featured-thumb-data shadow-one">
                                                        ...
                                                        <div class="bg-gray quantity px-4 pt-4">
                                                            <ul>
                                                                <li><span><?php echo $row['12']; ?></span> carrés</li>
                                                                <li><span><?php echo $row['6']; ?></span> Lits</li>
                                                                <li><span><?php echo $row['7']; ?></span> Bains</li>
                                ...
                                <ul>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>"Les mieux notés" est une expression utilisée pour désigner les éléments ou les produits qui ont reçu les meilleures notes ou les meilleures critiques dans une certaine catégorie ou domaine.</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p> une expérience de qualité se distingue par sa capacité à offrir une satisfaction élevée, une fiabilité, une personnalisation, une facilité d'utilisation, des interactions positives, une valeur ajoutée et un engagement émotionnel pour les individus qui y participent.</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>les agents expérimentés sont des professionnels qui possèdent une expertise approfondie, des compétences techniques avancées, une capacité à résoudre des problèmes complexes et une capacité à guider et à soutenir les autres membres de leur équipe.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <p>
                                    Discussion is a discourse or conversation between individuals or groups, typically involving the exchange of ideas, opinions, information, or viewpoints on a particular topic or subject matter</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <p>L'« examen des dossiers » désigne le processus d'évaluation et d'analyse minutieuse de documents, de dossiers ou de fichiers pour recueillir des informations, évaluer leur contenu et prendre des décisions en fonction des informations obtenues. </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <p>Le verbe "acquérir" en français se réfère à l'action d'obtenir ou de posséder quelque chose, que ce soit des connaissances, des compétences, des biens matériels, des droits, etc.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        ============================================================-->
                    ...
                    <div class="fact-counter">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                    <?php
                                    $query = mysqli_query($con, "SELECT count(pid) FROM property where stype='Vente'");
                                    while ($row = mysqli_fetch_array($query)) {
                                    ?>
                                        <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php
                                                                                                                $total = $row[0];
                            ...
                            <div class="col-md-3">
                                <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                    <?php
                                    $query = mysqli_query($con, "SELECT count(pid) FROM property where stype='Louer'");
                                    while ($row = mysqli_fetch_array($query)) {
                                    ?>
                                        <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php
                                                                                                                $total = $row[0];
            ...
            <div class="full-row bg-gray">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-secondary double-down-line text-center mb-5">Lieux populaires</h2>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(city), property.* FROM property where city='Tanger'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                            <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['16'] ?>"><?php echo $row['city']; ?></a></h4>
                                            <span><?php
                                                    $total = $row[0];
                                                    echo $total; ?> Propriétés répertoriées</span>
                                    </div>
                                <?php } ?>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/2.jpg" alt="">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(city), property.* FROM property where city='Casa'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                            <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['16'] ?>"><?php echo $row['city']; ?></a></h4>
                                            <span><?php
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(city), property.* FROM property where city='Rabat'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                            <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['16'] ?>"><?php echo $row['city']; ?></a></h4>
                                            <span><?php
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(city), property.* FROM property where city='Marrakech'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                            <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['16'] ?>"><?php echo $row['city']; ?></a></h4>
                                            <span><?php
