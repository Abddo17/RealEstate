  ...
  <div class="header" style="background-color: black;">
                ...
                <div class="header-left">
                    <a href="dashboard.php" >
						<img src="assets/img/white_krihouse.png" alt="Logo" style="height: 80px !important;height:40px;">
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/krihouse.png" alt="Logo" width="30" height="30" style="width: 70px;height:50px">
					</a>
                </div>
				<!-- /Logo -->
