						...
						<div class="loginbox">
							<div class="login-right">
								<div class="login-right-wrap">
									<h1>Se connecter</h1>
									<p class="account-subtitle">Accès à votre Espace</p>
									...
									<form method="post">
										...
										<div class="form-group">
											<input type="password" name="pass" class="form-control" placeholder="Votre Password">
										</div>

										<button class="btn btn-success" name="login" value="Login" type="submit">Se connecter</button>
									...
									<div class="text-center dont-have">Vous n'avez pas de compte ? <a href="register.php">Registre</a></div>
