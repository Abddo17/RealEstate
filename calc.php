        ...
        <div class="row">
            ...
            <div class="full-row bg-gray">
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-lg-12">
                            <h2 class="text-secondary double-down-line text-center">Calculatrice EMI</h2>
                        </div>
                    </div>
                    <center>
                        <table class="items-list col-lg-6 table-hover" style="border-collapse:inherit;">
                            <thead>
                                <tr class="bg-secondary">
                                    <th class="text-white font-weight-bolder">Terme</th>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><b><?php echo 'MAD ' . $interest; ?></b></td>
                                </tr>
                                <tr class="text-center">
                                    <td><b>Montant total</b></td>
                                    <td><b><?php echo 'MAD ' . $pay; ?></b></td>
                                </tr>
                                <tr class="text-center">
                                    <td><b>Paiement par mois (EMI)</b></td>
                                    <td><b><?php echo 'MAD ' . $month; ?></b></td>
                                </tr>
