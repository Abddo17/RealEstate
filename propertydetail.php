                        ...
                        ?>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-success text-left h5 my-2 text-md-right">MAD <?php echo $row['13']; ?></div>
                                ...
                                <div class="property-details">
                                    <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                        <ul>
                                            <li><span class="text-secondary"><?php echo $row['12']; ?></span> Pied carré</li>
                                            ...
                                            <li><span class="text-secondary"><?php echo $row['10']; ?></span> Salle</li>
                                    ...
                                    <h5 class="mt-5 mb-4 text-secondary">Propriété Sommaire</h5>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <button class="bg-gray hover-bg-success hover-text-white text-ordinary py-3 px-4 mb-1 w-100 text-left rounded position-relative" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> Plan de maison</button>
                        ...
                        <form method="post" action="#">
                            ...
                            <form class="d-inline-block w-100" action="calc.php" method="post">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="text" class="form-control" name="amount" placeholder="Montant de la propriété">
                                </div>
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="text" class="form-control" name="month" placeholder="Durée Par Année">
                                </div>
